...
class CategoriesApi(object):
    ...
    def get_category_by_id_month(self, budget_id, category_id, month, **kwargs):  # noqa: E501
        """Single category for budget month  # noqa: E501

        Returns a single category for specific month  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass use_async=True
        >>> thread = api.get_category_by_id_month(budget_id, category_id, month, use_async=True)
        >>> result = thread.get()

        :param async bool
        :param str budget_id: The ID of the Budget. (required)
        :param str category_id: The ID of the Category. (required)
        :param str month: Specific budget month. (required)
        :return: CategoryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_category_by_id_month_with_http_info(budget_id, category_id, month, **kwargs)  # noqa: E501
        else:
            (data) = self.get_category_by_id_month_with_http_info(budget_id, category_id, month, **kwargs)  # noqa: E501
            return data

    def get_category_by_id_month_with_http_info(self, budget_id, category_id, month, **kwargs):  # noqa: E501
        """Single category for budget month  # noqa: E501

        Returns a single category  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass use_async=True
        >>> thread = api.get_category_by_id_month_with_http_info(budget_id, category_id, month, use_async=True)
        >>> result = thread.get()
        ...
        all_params = ['budget_id', 'category_id', 'month']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_category_by_id_month" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'budget_id' is set
        if ('budget_id' not in params or
                params['budget_id'] is None):
            raise ValueError("Missing the required parameter `budget_id` when calling `get_category_by_id_month`")  # noqa: E501
        # verify the required parameter 'category_id' is set
        if ('category_id' not in params or
                params['category_id'] is None):
            raise ValueError("Missing the required parameter `category_id` when calling `get_category_by_id_month`")  # noqa: E501
        # verify the required parameter 'category_id' is set
        if ('month' not in params or
                params['month'] is None):
            raise ValueError("Missing the required parameter `month` when calling `get_category_by_id_month`")  # noqa: E501
